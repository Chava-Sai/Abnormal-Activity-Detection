...
#$ -P cs585
#$ -N violence_joint
#$ -o /projectnb/cs585/students/saichava/logs/joint_$JOB_ID.out
#$ -e /projectnb/cs585/students/saichava/logs/joint_$JOB_ID.err
#$ -l h_rt=24:00:00
#$ -l gpus=1
#$ -l gpu_c=7.0
#$ -l gpu_memory=40G
...
OUT_DIR=$PROJ/experiments/joint_run_$(date +%Y%m%d_%H%M%S)
SCHEDULE=joint
