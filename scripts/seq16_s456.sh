...
#$ -P cs585
#$ -N seq16_s456
#$ -o /projectnb/cs585/students/saichava/logs/seq16_s456_$JOB_ID.out
#$ -e /projectnb/cs585/students/saichava/logs/seq16_s456_$JOB_ID.err
#$ -l h_rt=12:00:00
#$ -l gpus=1
#$ -l gpu_c=7.0
#$ -l gpu_memory=20G
...
python3 ~/violence_detection/src/train.py \
  ...
  --num_segments 16 --seed 456 --epochs 100 \
  --checkpoint_dir $PROJ/experiments/seq16_seed456/checkpoints \
  --log_dir        $PROJ/experiments/seq16_seed456/logs
